...
import { BookOpen, Mail, Lock, User, Eye, EyeOff, ArrowRight, Church } from "lucide-react";
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 leather-texture items-center justify-center p-12 relative overflow-hidden">
        ...
        >
          ...
          <div className="mt-12 flex items-center justify-center gap-6">
            {[
              { number: "50K+", label: "Believers" },
              { number: "1M+", label: "Devotionals" },
              { number: "4.9", label: "Rating" },
            ].map((stat) => (
              <div key={stat.label} className="text-center">
                <p className="text-xl font-bold text-accent-400">{stat.number}</p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <h1 className="text-3xl font-serif font-bold text-primary mb-2">Begin Your Journey</h1>
          <p className="text-warm-500 mb-8">Create your account and start growing in faith today.</p>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium text-warm-700 mb-1.5 block">Password</label>
              <div className="relative">
              ...
              <p className="text-xs text-warm-400 mt-1">At least 8 characters</p>
            </div>
            <div>
              ...
              <p className="text-xs text-warm-400 mt-1">This helps us tailor content to your tradition</p>
            </div>
